...
import DingTalkSender from '../packages/dingtalk-sender/dist/index.mjs';
...
if (currentFile && scriptFile && currentFile.includes('dingtalk-push-from-package.mjs') && scriptFile.includes('dingtalk-push-from-package.mjs')) {
  main().catch(error => {
